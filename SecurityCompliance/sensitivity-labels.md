...
Each item of content can have a single sensitivity label applied to it. But note that an item can have both a sensitivity label and a retention label applied to it.
